...
#------------------------------
    ...
    probdata.add_param('h_left', .28, 'Left boundary value')
    probdata.add_param('h_right', .025, 'Right boundary value')

    probdata.add_param('gamma', .1, 'Coefficient of fourth-order term')
